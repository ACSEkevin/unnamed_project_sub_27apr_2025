...
from models.associatr import init_from_pretrained_detr
...
def get_args_parser():
    ...
    parser.add_argument('--set_cost_objness', default=1, type=float,
                        help="objectness coef in the matching cost")
    ...
    parser.add_argument('--objness_loss_coef', default=1, type=float)
    parser.add_argument('--eos_coef', default=0.1, type=float,
                        help="Relative classification weight of the no-object class")

    # dataset parameters
    parser.add_argument('--dataset_file', default='bddmot20')
...
def main(args):
    ...
    dataset_train, _collate_fn = build_dataset(image_set='train', args=args)
    ...
    data_loader_train = DataLoader(dataset_train, batch_sampler=batch_sampler_train,
                                   collate_fn=_collate_fn, num_workers=args.num_workers)
    data_loader_val = DataLoader(dataset_val, args.batch_size, sampler=sampler_val,
                                 drop_last=False, collate_fn=_collate_fn, num_workers=args.num_workers)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('AssociaTR training and evaluation script', parents=[get_args_parser()])
