...
class DETR(nn.Module):
    ...
    def forward(self, samples: NestedTensor):
        ...
        hs: torch.Tensor = self.transformer(self.input_proj(src), mask, self.query_embed.weight, pos[-1])[0]
...
class PostProcess(nn.Module):
    ...
    def forward(self, outputs, target_sizes):
        ...
        assert len(out_logits) == len(target_sizes), "{} vs. {}".format(out_logits.size(), target_sizes)
